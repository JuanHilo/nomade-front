      ...
      <div className="relative z-10 flex flex-col h-full px-8 py-8">
        ...
        <nav className="flex-1 space-y-8">
          {menuSections.map((section, sectionIndex) => (
            <div key={sectionIndex} className="space-y-4">
              {/* Section Title */}
              <div>
                <h3 className="text-label-sm text-white">
                  {section.title}
                </h3>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className={`text-nav transition-colors duration-300 ${
        ...
        <div className="border-t border-white/10 pt-6">
          ...
          <div className="bg-white/5 rounded-xl p-4 mb-4">
            <div className="text-label-sm text-white/60 mb-1">Portfolio Value</div>
            <div className="text-metric-lg text-white">€98.7M</div>
            <div className="text-body-xs text-nomade-green">+12.4% this quarter</div>
          </div>
          
          {/* Profile Actions */}
          <div className="space-y-2">
            <button className="w-full flex items-center space-x-3 px-4 py-3 text-nomade-off-white/60 hover:bg-white/5 hover:text-white rounded-xl transition-all duration-300 text-nav">
            ...
            <button className="w-full flex items-center space-x-3 px-4 py-3 text-nomade-off-white/60 hover:bg-red-500/10 hover:text-red-400 rounded-xl transition-all duration-300 text-nav">
